...
#ifndef _OPENCOG_CONFIG_URL_HANDLER_H
#define _OPENCOG_CONFIG_URL_HANDLER_H
...
class ConfigURLHandler: public BaseURLHandler
{
...
#endif // _OPENCOG_CONFIG_URL_HANDLER_H
